            ...
            if not cur.fetchone():
                ...
                with open(_path / 'accounts.csv.bak') as infile:
                    ...
                    for line in infile:
                        ...
                        cur.execute(
                            "INSERT INTO accounts (account_num, owner, balance) VALUES (?, ?, ?);",
                            (account_num, owner, balance))#fixed
    ...
    def create_account(self, acct: Account) -> Account:
        ...
        with sqlite3.connect(self.db_file) as conn:
            ...
            cur.execute(
                ...
                (acct.account_num, acct.owner_name, acct.balance));#fixed
            if cur.rowcount == 0:
                return None
        return acct
    ...
    def update_account(self, acct: Account) -> Optional[Account]:
        ...
        with sqlite3.connect(self.db_file) as conn:
            ...
            cur.execute(
                ...
                (acct.owner_name, acct.balance, acct.notes, acct.account_num))#fixed
